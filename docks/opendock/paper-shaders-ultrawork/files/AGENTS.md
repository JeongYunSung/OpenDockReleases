...
- 검수 기준은 `.opendock/docks/paper-shaders-ultrawork/README.md`, `.opendock/docks/paper-shaders-ultrawork/HARNESS.md`, `.opendock/docks/paper-shaders-ultrawork/PAPER_SHADERS.md`, `.opendock/docks/paper-shaders-ultrawork/SHADER_PLAYBOOK.md`에서 읽습니다.
