...
3. 검수와 ultrawork에서는 선택한 shader 산출물에 `node .opendock/harness/paper-shaders-ultrawork/check.mjs --target <path>`를 실행합니다. 사용자가 프로젝트 전체 검수를 명시한 경우에만 `--release`를 사용합니다.
