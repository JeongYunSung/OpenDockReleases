...
description: 사용자가 검수, ultrawork, release 중 하나를 명시해 Paper Shaders Ultrawork 정밀 검수를 요청한 경우에만 사용합니다.
---
...
- 기준 문서는 `.opendock/docks/paper-shaders-ultrawork/README.md`, `.opendock/docks/paper-shaders-ultrawork/HARNESS.md`, `.opendock/docks/paper-shaders-ultrawork/PAPER_SHADERS.md`, `.opendock/docks/paper-shaders-ultrawork/SHADER_PLAYBOOK.md`입니다.
