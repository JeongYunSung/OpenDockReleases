...
- `.opendock/docks/paper-shaders-ultrawork/PAPER_SHADERS.md`와 `.opendock/data/paper-shaders/catalog.json`이 설치되어 있어야 합니다.
- `.opendock/docks/paper-shaders-ultrawork/SHADER_PLAYBOOK.md`와 `.opendock/templates/paper-shaders/SHADER_REQUEST.md`가 설치되어 있어야 합니다.
- catalog에는 공식 Paper Shaders 29개 항목과 설명, 우측 사이드바형 controls가 있어야 합니다.
- `.codex/opendock/paper-shaders-ultrawork`에는 OpenDock-managed `@paper-design/shaders-react` npm dependency가 설치되어 있어야 합니다.
...
- 실제 shader 사용 코드가 없으면 준비 상태로 통과합니다.
