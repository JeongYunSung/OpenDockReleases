---
name: opendock-ultrawork
description: All-in-one OpenDock quality harness for design, frontend, backend, Kotlin/Spring, data, DevOps, docs, product, marketing, mobile, security, and QA completion gates.
---

# Ultrawork

Use this skill when finishing or reviewing any project work that should meet a strong definition of done.
...
Treat harness failures as blockers unless there is a documented project-specific exception.
