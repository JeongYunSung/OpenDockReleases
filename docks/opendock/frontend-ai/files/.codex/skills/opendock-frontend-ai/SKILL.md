---
name: opendock-frontend-ai
description: React, Next.js, TypeScript, component, accessibility, and review guidance. Use when working with Frontend engineers and product teams building web interfaces..
---
