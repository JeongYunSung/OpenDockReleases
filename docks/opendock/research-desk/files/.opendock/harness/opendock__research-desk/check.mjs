...
const config = {
  "title": "Research Desk",
  "slug": "research-desk",
  "domainFile": "RESEARCH_DESK.md",
  "templatePath": ".opendock/templates/research-desk/RESEARCH_RUN.md",
  "runDir": ".opendock/runs/research-desk",
  "skillPath": ".agents/skills/opendock-research-desk/SKILL.md",
  "workflowPath": ".agents/workflows/opendock-research-desk/quality-gate.md",
  "requiredSections": [
    "리서치 질문",
    "출처 목록",
    "근거 표",
