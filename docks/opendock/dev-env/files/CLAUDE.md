# Dev Env Claude Code Guidance

Claude Code should use this dock as persistent project memory for: Developers and teams that want AI agents to use the same local commands as humans.

## Load Order

1. Read AGENTS.md for the shared operating contract.
2. Read this file for Claude-specific behavior.
3. Use /opendock-dev-env when the task matches this dock and the skill is available.
4. Read the dock reference files only when they are relevant to the current task.

## Claude-Specific Rules

- Keep CLAUDE.md concise; move repeatable procedures into .claude/skills/opendock-dev-env/SKILL.md.
