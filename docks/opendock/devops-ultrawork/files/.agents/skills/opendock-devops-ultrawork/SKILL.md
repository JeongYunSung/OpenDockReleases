...
description: 사용자가 검수, ultrawork, release 중 하나를 명시해 DevOps Ultrawork 정밀 검수를 요청한 경우에만 사용합니다.
---
...
- 기준 문서는 `.opendock/docks/devops-ultrawork/README.md`, `.opendock/docks/devops-ultrawork/HARNESS.md`입니다.
