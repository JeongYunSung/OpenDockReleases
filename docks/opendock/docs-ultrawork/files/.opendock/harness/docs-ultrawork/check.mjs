...
const config = {
  "title": "Docs Ultrawork",
  "focus": "documentation quality gates",
  "patterns": [
    {
    ...
    {
      "id": "missing-code-fence-language",
      "globs": [
        "**/*.md"
      ],
      "pattern": "^```[ \\t]*$",
      "message": "Opening code fences should declare a language."
    },
    {
      "id": "todo-docs",
      "globs": [
      ...
      "pattern": "(?i)\\b(todo|tbd|fixme|lorem ipsum)\\b",
      "message": "Documentation should not ship placeholders."
    },
    {
      "id": "old-package-name",
      "globs": [
      ...
      "pattern": "(?i)oh-my-codex|oh-my-openagent|starterpackhub|dockhub",
      "message": "Remove stale product/package names."
    },
    {
      "id": "broken-local-link-shape",
      "globs": [
        "**/*.md"
      ],
      "pattern": "\\]\\((?!https?://|#|/|\\.\\.?/)[^)]+\\.md\\)",
      "message": "Relative markdown links should be explicit."
    }
  ]
};
...
const ignoredRootFiles = new Set(["AGENTS.md", "CLAUDE.md", "GEMINI.md", ".opendock/docks/docs-ultrawork/HARNESS.md"]);
