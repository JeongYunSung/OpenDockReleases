...
const runSlug = "mobile-ultrawork";
...
const config = {
  "title": "Mobile Ultrawork",
  "focus": "mobile app quality gates",
  "patterns": [
    {
    ...
    },
    {
      ...
      "pattern": "\\bprint\\(",
      "message": "Dart print must not remain."
    },
    {
      "id": "react-native-console",
      "globs": [
        "**/*.tsx",
        "**/*.jsx",
        "**/*.ts",
    ...
    },
    {
      ...
      "pattern": "!\\s*(\\.|\\)|,|$)",
      "message": "Swift force unwrap needs review."
    },
    {
      "id": "android-permission-without-rationale",
      "globs": [
        "**/AndroidManifest.xml",
        "**/*.xml"
      ],
      "pattern": "uses-permission(?![\\s\\S]{0,300}(rationale|reason|purpose))",
      "message": "Permissions need rationale documentation."
    },
    {
      "id": "missing-mobile-states",
      "globs": [
        "**/*.md",
        "**/*.tsx",
        "**/*.dart",
    ...
    },
    {
      ...
      "pattern": "(?i)(await|async|suspend)(?![\\s\\S]{0,250}(catch|try|Result|Either|error))",
      "message": "Async mobile flows need error handling."
    }
  ]
};
...
const ignoredRootFiles = new Set(["AGENTS.md", "CLAUDE.md", "GEMINI.md", ".opendock/docks/mobile-ultrawork/HARNESS.md", ".opendock/docks/mobile-ultrawork/README.md"]);
