...
4. `node .opendock/harness/creative-gen-ultrawork/check.mjs --manifest .opendock/runs/creative-gen/<작업-id>/manifest.md`를 실행하고 실패를 수정합니다. 프로젝트 전체 검수 요청일 때만 `--release`를 사용합니다.
