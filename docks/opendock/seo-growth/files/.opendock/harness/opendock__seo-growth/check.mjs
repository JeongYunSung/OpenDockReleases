...
const config = {
  "title": "SEO Growth",
  "slug": "seo-growth",
  "domainFile": "SEO_GROWTH.md",
  "templatePath": ".opendock/templates/seo-growth/SEO_RUN.md",
  "runDir": ".opendock/runs/seo-growth",
  "skillPath": ".agents/skills/opendock-seo-growth/SKILL.md",
  "workflowPath": ".agents/workflows/opendock-seo-growth/quality-gate.md",
  "requiredSections": [
    "대상 독자",
    "검색 의도",
    "메타데이터",
