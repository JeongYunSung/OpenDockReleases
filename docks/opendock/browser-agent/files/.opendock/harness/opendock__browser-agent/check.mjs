...
const requiredFiles = ["BROWSER_AGENT.md", "HARNESS.md"];
const runDir = ".opendock/runs/browser-agent";
const templateFile = ".opendock/templates/browser-agent/BROWSER_AGENT_RUN.md";
const failures = [];
...
const requiredFieldPattern = /(Target|Allowed\s+domains|Disallowed\s+actions|Task)\s*:/i;
