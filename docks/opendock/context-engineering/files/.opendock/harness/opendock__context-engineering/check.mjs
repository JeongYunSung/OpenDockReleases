...
const requiredFiles = ["CONTEXT_ENGINEERING.md", "HARNESS.md"];
const runDir = ".opendock/runs/context-engineering";
const templateFile = ".opendock/templates/context-engineering/CONTEXT_PACK.md";
const failures = [];
...
const requiredFieldPattern = /(Question|Target\s+scope|Source\s+files|Excluded\s+paths)\s*:/i;
