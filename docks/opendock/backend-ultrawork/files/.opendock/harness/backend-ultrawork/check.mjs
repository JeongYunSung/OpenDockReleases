...
const runSlug = "backend-ultrawork";
...
const config = {
  ...
  "patterns": [
    ...
    },
    {
      ...
      "pattern": "(?i)(password|secret|token|api[_-]?key)\\s*[:=]\\s*[\"\\'][A-Za-z0-9+/_=-]{16,}[\"\\']",
      "message": "High-confidence hardcoded credential literal."
    }
  ],
  "packageScripts": [
    "lint",
...
const ignoredRootFiles = new Set(["AGENTS.md", "CLAUDE.md", "GEMINI.md", ".opendock/docks/backend-ultrawork/HARNESS.md", ".opendock/docks/backend-ultrawork/README.md"]);
