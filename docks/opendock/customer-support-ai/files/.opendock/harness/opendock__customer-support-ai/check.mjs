...
const config = {
  ...
  "domainFile": "CUSTOMER_SUPPORT.md",
  "templatePath": ".opendock/templates/customer-support/SUPPORT_RUN.md",
  "runDir": ".opendock/runs/customer-support",
  "skillPath": ".agents/skills/opendock-customer-support-ai/SKILL.md",
  "workflowPath": ".agents/workflows/opendock-customer-support-ai/quality-gate.md",
  "requiredSections": [
    "지원 목표",
    "톤 원칙",
    "정책 기준",
