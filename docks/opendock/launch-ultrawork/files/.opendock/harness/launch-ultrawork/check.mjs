...
const config = {
  "title": "Launch Ultrawork",
  "slug": "launch-ultrawork",
  "domainFile": ".opendock/docks/launch-ultrawork/LAUNCH.md",
  "templatePath": ".opendock/templates/launch/LAUNCH_RUN.md",
  "runDir": ".opendock/runs/launch",
  "skillPath": ".agents/skills/opendock-launch-ultrawork/SKILL.md",
  "workflowPath": ".agents/workflows/opendock-launch-ultrawork/quality-gate.md",
  "requiredSections": [
    "목표",
    "범위",
    "출시 체크리스트",
...
function main() {
  const required = [config.domainFile, ".opendock/docks/launch-ultrawork/HARNESS.md", config.templatePath, config.skillPath, config.workflowPath];
