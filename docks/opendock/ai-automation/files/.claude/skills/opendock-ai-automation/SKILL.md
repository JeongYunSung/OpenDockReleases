---
description: A practical workspace for mapping and designing safe internal automations. Use when working with Operations, marketing, support, and internal tooling teams.
---
