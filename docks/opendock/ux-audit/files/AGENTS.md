# UX Audit
- UX 감사는 `.opendock/docks/ux-audit/UX_AUDIT_PLAYBOOK.md`를 기준으로 처리합니다.
- 평소에는 별도 준비 없이 사용자 요청을 바로 수행합니다.
- `.opendock/templates/ux-audit/RUN.md`는 도움이 될 때 필요한 섹션만 선택해 사용합니다.
- 사용자가 검토를 요청하면 AI가 현재 결과물만 플레이북 기준으로 직접 검토합니다.
## 안전
- 개인정보를 최소화하고 관찰하지 않은 사용자 행동이나 접근성 준수를 단정하지 않습니다.
