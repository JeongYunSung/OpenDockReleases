...
const ignoredRootFiles = new Set(["AGENTS.md", "CLAUDE.md", "GEMINI.md", ".opendock/docks/qa-ultrawork/HARNESS.md", ".opendock/docks/qa-ultrawork/README.md"]);
