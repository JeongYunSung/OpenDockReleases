...
1. Read `HARNESS.md`.
2. Review the changed files against the checklist, including accessibility evidence when a11y is claimed done.
3. Run `node .opendock/harness/opendock__qa-ultrawork/check.mjs`.
