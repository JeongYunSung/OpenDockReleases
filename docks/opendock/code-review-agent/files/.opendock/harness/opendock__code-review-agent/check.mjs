...
const title = "Code Review Agent";
const requiredFiles = ["CODE_REVIEW.md", "HARNESS.md"];
const runDir = ".opendock/runs/code-review-agent";
const templateFile = ".opendock/templates/code-review-agent/CODE_REVIEW_RUN.md";
const failures = [];
...
const requiredFieldPattern = /(Scope|Changed\s+files|Findings|Severity)\s*:/i;
