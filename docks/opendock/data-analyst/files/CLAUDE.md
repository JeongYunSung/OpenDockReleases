# Data Analyst Claude Code Guidance

Claude Code should use this dock as persistent project memory for: Data analysts, PMs, founders, and operators who need decision-ready metrics.

## Load Order

1. Read AGENTS.md for the shared operating contract.
2. Read this file for Claude-specific behavior.
3. Use /opendock-data-analyst when the task matches this dock and the skill is available.
4. Read the dock reference files only when they are relevant to the current task.

## Claude-Specific Rules

- Keep CLAUDE.md concise; move repeatable procedures into .claude/skills/opendock-data-analyst/SKILL.md.
